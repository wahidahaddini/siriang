		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="<?= base_url()."assets/vendor/login/"?>images/img-01.png" alt="IMG">
				</div>

				<form class="login100-form validate-form" method="post" action="<?= base_url()."login/aksi_login"?>">
					...
					<div class="wrap-input100 validate-input">
						<p style="color: red; font-size: 12px; text-align: center;"> <?= $this->session->flashdata("msg")?></p>
					</div>
